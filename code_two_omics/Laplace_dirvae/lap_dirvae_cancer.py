...
import multiomics.code_two_omics.evaluation as evaluation
import numpy as np
...
class SharedAndSpecificLoss(nn.Module):
    ...
    def forward(self, params):
        (shared1_output, shared2_output, specific1_output, specific2_output,
        shared1_rec, shared2_rec, shared3_rec, specific1_rec, specific2_rec, ori1, ori2,
        shared1_mlp, shared2_mlp, specific1_mu, specific1_sig, specific2_mu, specific2_sig, temperature, batch_size) = params
...
class SharedAndSpecificEmbedding(nn.Module):
    def __init__(self, view_size, n_units_1, n_units_2, mlp_size):
    ...
    def forward(self, view1_input, view2_input, view3_input):
        ...
        return view1_specific_em, view1_specific_mu, view1_specific_sig, view1_shared_em, view2_specific_em, \
            view2_specific_mu, view2_specific_sig, view2_shared_em, view1_specific_rec, view1_shared_rec, view2_specific_rec, \
...
def main(args):
    ...
    if USE_GPU:
        view1_test_data, view2_test_data = Variable(view1_test_data.cuda()), Variable(view2_test_data.cuda())
    else:
    ...
    view1_specific_em_new, view1_specific_mu_new, view1_specific_sig_new, view1_shared_em_new, view2_specific_em_new, \
        view2_specific_mu_new, view2_specific_sig_new, view2_shared_em_new, view1_specific_rec_new, view1_shared_rec_new, view2_specific_rec_new, \
    ...
    final_embedding = torch.cat(
        (view1_specific_em_new, view2_specific_em_new, view_shared_common), dim=1)
