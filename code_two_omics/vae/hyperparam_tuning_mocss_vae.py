...
from multiomics.code_two_omics.vae.training import train, validation, EarlyStopper
from multiomics.code_two_omics.loading_data import load_data
from multiomics.code_two_omics.vae.mocss_vae import setup_seed, SharedAndSpecificLoss, SharedAndSpecificEmbedding
import os
import warnings
...
EPOCHS = 100
LR = [.0006] #[.0003, .0002, .0001] #, .0004, .0005, .0006] # .0007
BATCH_SIZE = 32
USE_GPU = False
ADJ_PARAMETER = 10 # TODO: adjust it for the dataset
MODEL = "standard"
WEIGHT_DECAY = [4e-4] #[5e-4, 4e-4, 3e-4, 6e-4, 7e-4]
