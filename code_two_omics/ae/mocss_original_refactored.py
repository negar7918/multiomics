...
class SharedAndSpecificLoss(nn.Module):
    ...
    def forward(self, params):
        ...
        shared1_rec, shared2_rec, specific1_rec, specific2_rec, ori1, ori2,
        shared1_mlp, shared2_mlp, temperature, batch_size) = params
...
class SharedAndSpecificEmbedding(nn.Module):
    def __init__(self, view_size, n_units_1, n_units_2, mlp_size):
        ...
        self.shared1_l1, self.shared1_l2, self.shared1_l3, self.shared1_l4, self.shared1_l3_, self.shared1_l2_, \
            ...
            self.specific2_l3_, self.specific2_l2_, self.specific2_l1_, self.specific2_rec, self.view1_mlp1, self.view1_mlp2,\
            self.view2_mlp1, self.view2_mlp2 \
    ...
    def forward(self, view1_input, view2_input):
        ...
        return (view1_specific_em, view1_shared_em, view2_specific_em, view2_shared_em, view1_specific_rec,
                view1_shared_rec, view2_specific_rec, view2_shared_rec, view1_shared_mlp, view2_shared_mlp)
...
def main(args):
    ...
    view1_specific_em_new, view1_shared_em_new, view2_specific_em_new, \
         view2_shared_em_new,  view1_specific_rec_new, view1_shared_rec_new, view2_specific_rec_new, \
