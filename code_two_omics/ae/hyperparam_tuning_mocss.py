...
from multiomics.code_two_omics.ae.training import train, validation, EarlyStopper
from multiomics.code_two_omics.loading_data import load_data
from multiomics.code_two_omics.ae.mocss_original_refactored import setup_seed, SharedAndSpecificLoss, SharedAndSpecificEmbedding
import os
import warnings
...
def work(p):
    ...
    parent_dir = "./models_"+disease+"_ae"
