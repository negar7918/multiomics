...
def train(train_loader, view1_data, view2_data, model, loss_function, temperature, optimizer, epoch, USE_GPU, total_epochs):
    ...
    for iteration_index, train_batch in enumerate(train_loader):
        ...
        if USE_GPU:
            view1_train_data, view2_train_data = Variable(view1_train_data.cuda()), Variable(view2_train_data.cuda())
        else:
        ...
        view1_specific_em, view1_specific_alpha, view1_shared_em, view2_specific_em, view2_specific_alpha, \
            view2_shared_em, view1_specific_rec, view1_shared_rec, view2_specific_rec, \
            view2_shared_rec, view1_shared_mlp, view2_shared_mlp, = model(view1_train_data, view2_train_data)

        prior_alpha = torch.Tensor(1, 8).float().fill_(.5)

        params = (prior_alpha, view1_train_data, view2_train_data,
                  view1_shared_em, view2_shared_em,
                  view1_specific_em, view2_specific_em,
                  view1_shared_rec, view2_shared_rec,
                  view1_specific_rec, view2_specific_rec,
...
def validation(val_loader, view1_data, view2_data, model, temperature, loss_function, USE_GPU, epoch, total_epochs):
    ...
    for iteration_index, val_batch in enumerate(val_loader):
        ...
        if USE_GPU:
            view1_val_data, view2_val_data = Variable(view1_val_data.cuda()), Variable(view2_val_data.cuda())
        else:
        ...
        view1_specific_em, view1_specific_alpha, view1_shared_em, view2_specific_em, \
            ...
            view2_shared_rec, view1_shared_mlp, view2_shared_mlp, = model(view1_val_data, view2_val_data)

        prior_alpha = torch.Tensor(1, 8).float().fill_(.5)

        params = (prior_alpha, view1_val_data, view2_val_data,
                  view1_shared_em, view2_shared_em,
                  view1_specific_em, view2_specific_em,
                  view1_shared_rec, view2_shared_rec,
                  view1_specific_rec, view2_specific_rec,
